...
const App = () => {
  ...
  return (
    <div>
      ...
      <li>Transfer 10 tokens: <button disabled={loading} onClick={transferTokenHelper}>Send to Friends</button></li>
      <li>Cap Supply: <button disabled={loading} onClick={capSupplyHelper}>Cap Supply</button></li>
    </div>
  )
};
